    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios_1["default"].get("https://character-database.becode.xyz/characters")];
                case 1:
                    response = _a.sent();
...
getList().then(function (user) {
    ...
    for (i = 0; i < user.length; i++) {
        temp.content.querySelector(".card-title").innerHTML =
            user[i].name;
        temp.content.querySelector(".card-text").innerHTML =
            user[i].shortDescription;
        temp.content.querySelector("img").src =
            "data:image/gif;base64," + user[i].image;
        temp.content.querySelector("a").href =
